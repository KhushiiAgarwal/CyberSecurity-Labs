...
public class aestemp {
    ...
    public static void main(String[] args) {
        ...
        String ciphert = "0100110000100000";
    ...
    public static String encrypt(String plaintext, String[] roundKeys) {
        ...
        for (int round = 0; round < 3; round++) {
            state = addRoundKey(state, roundKeys[round * 2]); // Adjusted to use every second round key
            state = mixColumns(state);
        }
        state = addRoundKey(state, roundKeys[5]); // Adjusted to use the last round key
        return state;
    }
    ...
    // Helper method to pad binary string to 16 bits
